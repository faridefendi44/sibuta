...
<div id="sidebar"
    ...
    <div class="p-4">
        <button id="toggleSidebar" class=" absolute  -right-8 top-4 focus:outline-none">
            <svg class="h-6 w-6 text-black ml-1 absolute" fill="none" stroke="currentColor" viewBox="0 0 24 24"
    ...
    <h1 class="{{ Request::path() == 'logout' || Request::path() == 'login' ? 'active' : 'opacity-0' }} bg-red-400 bg-[#345C6D] w-1 h-full absolute left-0 child"></h1>
    <svg width="35" height="35" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="#fff">
        <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
        <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
        <g id="SVGRepo_iconCarrier">
            <path d="M2.00098 11.999L16.001 11.999M16.001 11.999L12.501 8.99902M16.001 11.999L12.501 14.999" stroke="white" stroke-width="1.5" />
    ...
    <span id="show" class="text-[12px] md:text-[18px] ml-4 ">{{ Auth::check() ? 'Logout' : 'Login' }}</span>
</a>
