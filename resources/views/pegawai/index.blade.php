...
@section('content')
    <div class="lg:w-[90%] px-2 mt-10  mx-auto space-y-10">
        <div class="search ">
            <form action="{{ route('pegawai.search') }}" method="GET" class="flex  items-center  mx-auto">
        ...
        <div class="">
            <a href="{{ route('pegawai.create') }}"
                ...
                <span class="mt-1">Tambah Pegawai</span>
            </a>
        </div>
                        ...
                        @foreach ($pegawais as $data)
                            <tr class="bg-[#D9D9D9] border-b    ">
                                <th scope="row"
                                    ...
                                    {{ $loop->iteration + ($pegawais->currentPage() - 1) * $pegawais->perPage() }}                                </th>
                                <td class="px-6 py-4">
                                    {{ $data->nama }}
                                </td>
                                <td class="px-6 py-4">
