    ...
    <div class="w-4/5 mt-10  mx-auto space-y-10">
        ...
        <div class="">
            <a href="{{ route('surat.create') }}"
                ...
                <span class="mt-1">Tambah Surat</span>
            </a>
        </div>
                ...
                <table class="w-full text-sm text-left rtl:text-right text-gray-500 bg-[#D9D9D9]">
                    ...
                    <tbody>
                        @foreach ($surats as $data)
                            <tr class="bg-[#D9D9D9] border-b    ">
                                ...
                                <td class="px-6 py-4 text-right">
                                    <div class="flex space-x-3">
                                        ...
                                        <a href="{{route('surat.show', $data->id)}}" class="font-medium text-blue-600  hover:underline">
                            ...
                            class="hidden overflow-y-auto overflow-x-hidden fixed top-80 right-0 md:left-[35%] z-50 justify-center items-center w-full md:inset-10 h-[calc(100%-1rem)] max-h-full">
                            <div class="relative p-4 w-full max-w-md max-h-full">
                                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                    <button type="button"
                                        class="absolute top-3 end-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white"
                                        data-modal-hide="popup-modal">
                                        <svg class="w-5 h-5 closeModal " aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                                    ...
                                    <div class="p-4 md:p-5 text-center">
                                        ...
                                        <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Anda yakin ingin menyetujui
                                            surat ini?</h3>
                        ...
                        <div aria-labelledby="modal-title" role="dialog" aria-modal="true" id="interestReject"
                            class="hidden overflow-y-auto overflow-x-hidden fixed top-80 right-0 md:left-[35%] z-50 justify-center items-center w-full md:inset-10 h-[calc(100%-1rem)] max-h-full">
                            <div class="relative p-4 w-full max-w-md max-h-full">
                                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                    <button type="button"
                        ...
                        <div aria-labelledby="modal-title" role="dialog" aria-modal="true" id="interestDelete"
                            class="hidden overflow-y-auto overflow-x-hidden fixed top-80 right-0 md:left-[35%] z-50 justify-center items-center w-full md:inset-10 h-[calc(100%-1rem)] max-h-full">
                            <div class="relative p-4 w-full max-w-md max-h-full">
                                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                    <button type="button"
