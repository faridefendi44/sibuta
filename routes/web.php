...
Route::prefix('laporan')->middleware('auth')->group(function () {
    ...
    Route::prefix('tamu')->middleware('auth')->group(function () {
...
Route::prefix('tamu')->group(function () {
    ...
    Route::get('/search', [TamuController::class, 'search'])->middleware('auth')->name('tamu.search');
    Route::post('/store', [TamuController::class, 'store'])->name('tamu.store');
    Route::get('/detail/{id}', [TamuController::class, 'show'])->middleware('auth')->name('tamu.show');
    Route::get('/edit/{id}', [TamuController::class, 'edit'])->middleware('auth')->name('tamu.edit');
    Route::put('/update/{id}', [TamuController::class, 'update'])->middleware('auth')->name('tamu.update');
    Route::post('/delete/{id}', [TamuController::class, 'delete'])->middleware('auth')->name('tamu.delete');
...
Route::prefix('surat')->group(function () {
    ...
    Route::get('/search', [SuratController::class, 'search'])->middleware('auth')->name('surat.search');
    Route::get('/detail/{id}', [SuratController::class, 'show'])->middleware('auth')->name('surat.show');
    Route::get('/edit/{id}', [SuratController::class, 'edit'])->middleware('auth')->name('surat.edit');
    Route::put('/update/{id}', [SuratController::class, 'update'])->middleware('auth')->name('surat.update');
    Route::post('/delete/{id}', [SuratController::class, 'delete'])->middleware('auth')->name('surat.delete');
